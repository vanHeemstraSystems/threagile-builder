...
-   所有构建目标都使用[孵化VCS](https://github.com/ofek/hatch-vcs) build hook plugin to ship a `_version.py`文件，以便可以在运行时使用该版本
...
`threagile-builder`是根据以下条款分发的[和](https://spdx.org/licenses/MIT.html) license.
