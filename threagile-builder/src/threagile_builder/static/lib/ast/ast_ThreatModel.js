Blockly.Blocks['ast_ThreatModel'] = {
    init: function () {
        this.decorators_ = 0;
        this.bases_ = 0;
        this.keywords_ = 0;
        this.appendDummyInput('HEADER')
            .appendField("Threat Model")
...
Blockly.Python['ast_ThreatModel'] = function (block) {
    // Name
...
BlockMirrorTextToBlocks.prototype['ast_ThreatModel'] = function (node, parent) {
    let name = node.name;
    ...
    return BlockMirrorTextToBlocks.create_block("ast_ThreatModel", node.lineno, fields,
        values,
        {
            "inline": "false"
        }, {
