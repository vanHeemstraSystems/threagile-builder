...
function BlockMirrorBlockEditor(blockMirror) {
  console.debug('BlockMirrorBlockEditor');
...
BlockMirrorBlockEditor.prototype.resizeResponsively = function () {
  console.debug('BlockMirrorBlockEditor.resizeResponsively');
...
BlockMirrorBlockEditor.prototype.setMode = function (mode) {
  console.debug('BlockMirrorBlockEditor.setMode');
...
BlockMirrorBlockEditor.prototype.getCode = function () {
  console.debug('BlockMirrorBlockEditor.getCode');
...
BlockMirrorBlockEditor.prototype.setCode = function (code, quietly) {
  console.debug('BlockMirrorBlockEditor.setCode');
  if (this.isVisible()) {
    let result = this.blockMirror.textToBlocks.convertSource(
      '__main__.py',
      code
...
BlockMirrorBlockEditor.prototype.changed = function (event) {
  console.debug('BlockMirrorBlockEditor.changed');
  if (
    (event === undefined ||
...
BlockMirrorBlockEditor.prototype.isVisible = function () {
  console.debug('BlockMirrorBlockEditor.isVisible');
  return (
...
BlockMirrorBlockEditor.prototype.loadBlocklyCSS = function () {
  console.debug('BlockMirrorBlockEditor.loadBlocklyCSS');
...
BlockMirrorBlockEditor.prototype.getPngFromBlocks = function (callback) {
  console.debug('BlockMirrorBlockEditor.getPngFromBlocks');
  try {
    this.loadBlocklyCSS();
...
BlockMirrorBlockEditor.prototype.highlightLines = function (lines, style) {
  console.debug('BlockMirrorBlockEditor.highlightLines');
