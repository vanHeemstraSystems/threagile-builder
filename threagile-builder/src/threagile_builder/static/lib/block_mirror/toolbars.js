...
TOOLBOX_CATEGORY.OUTPUT_WITH_PLOTTING = {
    name: "Output", colour: "PLOTTING", blocks: [
        "print(___)",
        "plt.plot(___)",
        "plt.scatter(___, ___)",
        "plt.hist(___)",
...
TOOLBOX_CATEGORY.TURTLES = {
    name: "Turtles", colour: "PLOTTING", blocks: [
        "turtle.mainloop()",
        "turtle.forward(50)",
        "turtle.backward(50)",
        "turtle.right(90)",
...
TOOLBOX_CATEGORY.INPUT = {
    name: "Input", colour: "TEXT", blocks: [
        "input('')",
    ]
};
TOOLBOX_CATEGORY.VALUES = {
    name: "Values", colour: "TEXT", blocks: [
        '""',
        "0",
        "True"
    ]
...
TOOLBOX_CATEGORY.DICTIONARIES = {
    name: "Dictionaries", colour: "DICTIONARY", blocks: [
