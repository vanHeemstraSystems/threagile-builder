...
BlockMirrorTextToBlocks.prototype.convertSourceToCodeBlock = function (
  ...
  console.debug('BlockMirrorTextToBlocks.convertSourceToCodeBlock');
...
BlockMirrorTextToBlocks.prototype.convertSource = function (
  ...
  console.debug('BlockMirrorTextToBlocks.convertSource');
...
BlockMirrorTextToBlocks.prototype.recursiveMeasure = function (
  ...
  console.debug('BlockMirrorTextToBlocks.recursiveMeasure');
  if (node === undefined) {
    return;
  }
...
BlockMirrorTextToBlocks.prototype.measureNode = function (node) {
  console.debug('BlockMirrorTextToBlocks.measureNode');
  this.heights = [];
...
BlockMirrorTextToBlocks.prototype.getSourceCode = function (frm, to) {
  console.debug('BlockMirrorTextToBlocks.getSourceCode');
...
BlockMirrorTextToBlocks.prototype.convertBody = function (node, parent) {
  console.debug('BlockMirrorTextToBlocks.convertBody');
  this.levelIndex += 1;
...
BlockMirrorTextToBlocks.prototype.isTopLevel = function (parent) {
  console.debug('BlockMirrorTextToBlocks.isTopLevel');
...
BlockMirrorTextToBlocks.prototype.convertStatement = function (
  ...
  console.debug('BlockMirrorTextToBlocks.convertStatement');
  try {
...
BlockMirrorTextToBlocks.prototype.getChunkHeights = function (node) {
  console.debug('BlockMirrorTextToBlocks.getChunkHeights');
  let lineNumbers = [];
...
BlockMirrorTextToBlocks.create_block = function (
  ...
  console.debug('BlockMirrorTextToBlocks.create_block');
...
BlockMirrorTextToBlocks.prototype['ast_Module'] = function (node) {
  console.debug('BlockMirrorTextToBlocks.ast_Module');
  return this.convertBody(node.body, node);
};

BlockMirrorTextToBlocks.prototype['ast_Interactive'] = function (node) {
  console.debug('BlockMirrorTextToBlocks.ast_Interactive');
  return this.convertBody(node.body, node);
};
...
BlockMirrorTextToBlocks.prototype['ast_Pass'] = function () {
  console.debug('BlockMirrorTextToBlocks.ast_Pass');
...
BlockMirrorTextToBlocks.COLOR = {
  ...
  AUTHOR: 40,
  DATA_ASSETS: 40,
  TECHNICAL_COMPONENTS: 40,
  COMMUNICATION_LINKS: 40,
  TRUST_BOUNDARIES: 40,
};
